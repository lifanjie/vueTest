  ...
  var t,
    ...
    o = [].slice; t = { LF: '\n', NULL: '\x00' }; n = (function () {
      var e; function n (t, e, n) {
        ...
        var e, i, o, s, u; e = [this.command]; o = this.headers['content-length'] === false; if (o) {
        ...
        var i, r, o, s, u, a, c, f, h, l, p, d, g, b, m, v, y; s = e.search(RegExp('' + t.LF + t.LF)); u = e.substring(0, s).split(t.LF); o = u.shift(); a = {}; d = function (t) {
          ...
          h = parseInt(a['content-length']); i = ('' + e).substring(p, p + h)
        } else {
          r = null; for (c = b = p, y = e.length; p <= y ? b < y : b > y; c = p <= y ? ++b : --b) {
            r = e.charAt(c); if (r === t.NULL) {
              break
            }i += r
          }
        } return new n(o, a, i)
        ...
        var i; return (function () {
          var r, o, s, u; s = n.split(RegExp('' + t.NULL + t.LF + '*')); u = []; for (r = 0, o = s.length; r < o; r++) {
            i = s[r]; if ((i != null ? i.length : void 0) > 0) {
              u.push(e(i))
            }
          } return u
        }())
      ...
      var e; function r (t) {
        this.ws = t; this.ws.binaryType = 'arraybuffer'; this.counter = 0; this.connected = false; this.heartbeat = { outgoing: 1e4, incoming: 1e4 }; this.maxWebSocketFrameSize = 16 * 1024; this.subscriptions = {}
        ...
        var t, e, n, i; t = arguments.length >= 1 ? o.call(arguments, 0) : []; i = {}; switch (t.length) {
          case 2:
        ...
        var r, s, u, a; r = arguments.length >= 1 ? o.call(arguments, 0) : []; a = this._parseConnect.apply(this, r); u = a[0], this.connectCallback = a[1], s = a[2]; if (typeof this.debug === 'function') {
          this.debug('Opening Web Socket...')
        } this.ws.onmessage = (function (i) {
          return function (r) {
            var o, u, a, c, f, h, l, p, d, g, b, m; c = typeof ArrayBuffer !== 'undefined' && r.data instanceof ArrayBuffer ? (o = new Uint8Array(r.data), typeof i.debug === 'function' ? i.debug('--- got data length: ' + o.length) : void 0, (function () {
              ...
              i.debug('<<< ' + c)
            }b = n.unmarshall(c); m = []; for (d = 0, g = b.length; d < g; d++) {
              f = b[d]; switch (f.command) {
                case 'CONNECTED':
                  if (typeof i.debug === 'function') {
                    i.debug('connected to server ' + f.headers.server)
                  }i.connected = true; i._setupHeartbeat(f.headers); m.push(typeof i.connectCallback === 'function' ? i.connectCallback(f) : void 0); break; case 'MESSAGE':
                  ...
                  m.push(typeof i.onreceipt === 'function' ? i.onreceipt(f) : void 0); break; case 'ERROR':
                  m.push(typeof s === 'function' ? s(f) : void 0); break; default:
        ...
        }n.destination = t; this.subscriptions[n.id] = e; this._transmit('SUBSCRIBE', n); i = this; return { id: n.id,
        ...
        var e, n; n = t || 'tx-' + this.counter++; this._transmit('BEGIN', { transaction: n }); e = this; return { id: n,
          commit: function () {
            return e.commit(n)
          },
          abort: function () {
